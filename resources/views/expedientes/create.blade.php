<div class="max-w-3xl mx-auto">
    ...
    <form method="POST" action="{{ url('add-expediente') }}" enctype="multipart/form-data" class="grid grid-cols-3 gap-6 bg-white shadow-md rounded-lg py-8">
        ...
        <div>
            ...
            <x-form-text id="ap_paterno" class="" type="text" name="ap_paterno" :value="old('ap_paterno')" required autofocus autocomplete="ap_paterno" />
        ...
        <div>
            ...
            <x-form-text id="ap_materno" class="" type="text" name="ap_materno" :value="old('ap_materno')" required autofocus autocomplete="ap_materno"/>
        ...
        <div>
            ...
            <x-form-text id="tipo_doc" class="" type="text" name="tipo_doc" :value="old('tipo_doc')" required autofocus autocomplete="tipo_doc" />
    ...
    <fieldset class="border border-gray-300 p-4">
        ...
        <div>
            ...
            <x-form-text id="periodo1" class="" type="text" name="periodo1" :value="old('periodo1')" required autofocus autocomplete="periodo1"/>
        ...
        <div>
            ...
            <x-form-text id="fecha_de_exp_a_devolver" class="" type="date" name="fecha_de_exp_a_devolver" :value="old('fecha_de_exp_a_devolver')"  required autofocus autocomplete="fecha_de_exp_a_devolver"/>
        ...
        <div>
            ...
            <x-form-text id="proveido" class="" type="text" name="proveido" :value="old('proveido')" required autofocus autocomplete="proveido" />
        ...
        <div>
            ...
            <x-form-text id="fecha_proveido" class="" type="date" name="fecha_proveido" :value="old('fecha_proveido')" required autofocus autocomplete="fecha_proveido" />
        ...
        <div>
            ...
            <x-form-text id="num_exp_solicitud_devolucion" class="" type="text" name="num_exp_solicitud_devolucion" :value="old('num_exp_solicitud_devolucion')" required autofocus autocomplete="num_exp_solicitud_devolucion" />
            <x-input-error :messages="$errors->get('num_exp_solicitud_devolucion')" class="mt-2" />
        </div>
        <div>
            <x-form-label for="periodo2" :value="__('Periodo')" />
            <x-form-text id="periodo2" class="" type="text" name="periodo2" :value="old('periodo2')" required autofocus autocomplete="periodo2" />
            <x-input-error :messages="$errors->get('periodo2')" class="mt-2" />
        </div>
        <div>
            <x-form-label for="fecha_devolucion" :value="__('Fecha devolución')" />
            <x-form-text id="fecha_devolucion" class="" type="date" name="fecha_devolucion" :value="old('fecha_devolucion')" required autofocus autocomplete="fecha_devolucion" />
            <x-input-error :messages="$errors->get('fecha_devolucion')" class="mt-2" />
        </div>
        <div>
            <x-form-label for="fecha_registro" :value="__('Fecha Registro')" />
            <x-form-text id="fecha_registro" class="" type="date" name="fecha_registro" :value="old('fecha_registro')" required autofocus autocomplete="fecha_registro" />
    ...
    <fieldset class="border border-gray-300 p-4">
        ...
        <div>
            ...
            <x-form-text id="observacion" class="" type="text" name="observacion" :value="old('observacion')" required autofocus autocomplete="observacion" />
